     ...
     <div className="upperRightpart">
        ...
        {/* <div className="rightupperRightpart"> */}
            ...
            <div className="FiltersDiv">
                        ...
                        <div className='clothsleftarrow1'><button disabled={current===1} onClick={previous}><img src={LeftArrow} alt="leftarrow"></img></button></div>
                        <div style={{marginTop:"15px"}}>{current}</div>
                        <div className='clothsleftarrow2'><button disabled ={current==pages}onClick={next}><img src={LeftArrow} alt="leftarrow"></img></button></div>
...

{
    display.map((data) => (
        <div className="CartData">
            ...
            <img className="fullimage" src={data.image} alt="dataimg"></img>
            ...
            <p className="pricetag">${data.price}</p>
            {
                data.color?.map((colors,i)=>(
                    <button className="circlebutton" style={{margin:'0px 3px'}}><img src={data.color[colors,i]} alt="colorsimg"></img></button>
                ))
